...
export interface NftInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "countOfTokenId",
    values: [AddressLike, BigNumberish]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "BuurnPrice", data: BytesLike): Result;
...
export interface Nft extends BaseContract {
  ...
  BuurnPrice: TypedContractMethod<[], [bigint], "view">;
  ...
  burn: TypedContractMethod<[], [void], "payable">;

  countOfTokenId: TypedContractMethod<
  ...
  mint: TypedContractMethod<[_uri: string], [void], "payable">;
  ...
  getFunction(
    nameOrSignature: "countOfTokenId"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish],
    [bigint],
    "view"
  ...
  ): TypedContractMethod<[_uri: string], [void], "payable">;
  getFunction(
